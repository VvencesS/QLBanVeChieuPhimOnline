...
namespace ASP_WebForm_QLBanVeChieuPhimOnline.cms.admin.QuanLyPhim.QuocGia.Ajax
{
    public partial class QuocGia : System.Web.UI.Page
    {
        ...
        private void XoaQuocGia()
        {
            string MaQuocGia = "";
            if (Request.Params["MaQuocGia"] != null)
            {
                MaQuocGia = Request.Params["MaQuocGia"];

                //Thực hiện code xóa
                //B2: Xóa dữ liệu trên sqlserver
                ASP_WebForm_QLBanVeChieuPhimOnline.App_Code.database.QuanLyPhim.QuocGia.QuocGia_Delete(int.Parse(MaQuocGia));
