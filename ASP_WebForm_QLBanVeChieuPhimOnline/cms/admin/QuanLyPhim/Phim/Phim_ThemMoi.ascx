...
<div class="FormThemMoi">
    ...
    <div class="thongTin">
        ...
        <div class="oNhap">
            <asp:DropDownList ID="ddlTheLoai" runat="server"></asp:DropDownList></div>
    </div>
    <div class="thongTin">
        <div class="tenTruong">Chọn định dạng</div>
        <div class="oNhap">
            <asp:DropDownList ID="ddlDinhDang" runat="server"></asp:DropDownList></div>
    </div>
    <div class="thongTin">
        <div class="tenTruong">Chọn hãng phim</div>
        <div class="oNhap">
            <asp:DropDownList ID="ddlHangPhim" runat="server"></asp:DropDownList></div>
    </div>
    <div class="thongTin">
        <div class="tenTruong">Chọn quốc gia</div>
        <div class="oNhap">
            <asp:DropDownList ID="ddlQuocGia" runat="server"></asp:DropDownList></div>
    </div>
    <div class="thongTin">
        <div class="tenTruong">Chọn nhân viên thêm</div>
        <div class="oNhap">
            <asp:DropDownList ID="ddlNhanVien" runat="server"></asp:DropDownList></div>
    </div>
    <div class="thongTin">
    ...
    <div class="thongTin">
        ...
        <div class="oNhap">
            <CKEditor:CKEditorControl ID="tbTrailer" runat="server" FilebrowserImageBrowseUrl="ckeditor/ckfinder/ckfinder.aspx?type=Images&path=pic"></CKEditor:CKEditorControl>
    ...
    <div class="thongTin">
        ...
        <div class="oNhap">
            <asp:CheckBox ID="cbThemNhieuPhim" runat="server" Text="Tạo thêm phim khác sau khi tạo phim này" /></div>
    </div>
    <div class="thongTin">
        <div class="tenTruong">&nbsp;</div>
        <div class="oNhap">
