...
namespace ASP_WebForm_QLBanVeChieuPhimOnline.cms.admin.QuanLyPhim.Phim.Ajax
{
    public partial class Phim : System.Web.UI.Page
    {
        ...
        private void XoaPhim()
        {
            ...
            if (Request.Params["MaPhim"] != null)
            {
                ...
                ASP_WebForm_QLBanVeChieuPhimOnline.App_Code.database.QuanLyPhim.Phim.Phim_Delete(int.Parse(MaPhim));
