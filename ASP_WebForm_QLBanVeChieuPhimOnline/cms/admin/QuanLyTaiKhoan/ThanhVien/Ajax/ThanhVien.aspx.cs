...
namespace ASP_WebForm_QLBanVeChieuPhimOnline.cms.admin.QuanLyTaiKhoan.ThanhVien.Ajax
{
    public partial class ThanhVien : System.Web.UI.Page
    {
        ...
        {
            string MaThanhVien = "";
            if (Request.Params["MaThanhVien"] != null)
            {
                MaThanhVien = Request.Params["MaThanhVien"];

                //Thực hiện code xóa
                //B2: Xóa dữ liệu trên sqlserver
                ASP_WebForm_QLBanVeChieuPhimOnline.App_Code.database.QuanLyTaiKhoan.ThanhVien.ThanhVien_Delete(int.Parse(MaThanhVien));
